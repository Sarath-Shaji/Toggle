...
namespace Project
{
    public class ConnectionClass
    {
        ...
        public ConnectionClass()//Connection Class//Constructor
        {
            con = new SqlConnection(@"server=DESKTOP-B5AHIIT\SQLEXPRESS01;database=OrganizationDB;integrated security=true;");
        }
